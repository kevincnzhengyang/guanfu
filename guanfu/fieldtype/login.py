...
* @LastEditTime: 2022-08-13 12:44:15
...
class FieldLogin(justpy.Div):
    ...
    def __init__(self, **kwargs):
        ...
        self.classes = kwargs.get(
            "layout_class",
            FieldLogin._layout_class)

        # container
        c = justpy.Div(a=self,
                       classes=kwargs.get(
                            "container_class",
                            FieldLogin._container_class))

        # title
        justpy.H2(a=c,
                  classes=kwargs.get(
                        "title_class",
                        FieldLogin._title_class),
                  text=kwargs.get(
                        "title_text",
                        "Login"))
        ...
        ng = justpy.Div(a=f,
                        classes=kwargs.get(
                            "group_class",
                            FieldLogin._group_class))
        justpy.Label(a=ng,
                     classes=kwargs.get(
                            "label_class",
                        FieldLogin._label_class),
                     text=kwargs.get(
                            "name_lable",
                            "Username"))
        justpy.Input(a=ng,
        ...
        if kwargs.get("with_link", False):
            ...
            lg = justpy.Div(a=bg,
                            classes=kwargs.get(
                                "group_class",
                                FieldLogin._link_group_class))
            justpy.A(a=lg,
                    classes=kwargs.get(
                                "link_class",
                                FieldLogin._link_class),
                    text=kwargs.get(
                                "link1_text",
                                "Recover password!"),
                    href=kwargs.get(
